...
class UsMessengerTask(models.Model):
    ...
    _sql_constraints = [
        ('unique_name', 'unique (name, project_id)', 'This name already exists')
    ]
    ...
    developer_code = fields.Text("Developer Code")
    ...
    def run(self, job, function, args=None, kwargs=None, raise_on_error=True):
        ...
        try:
            ...
            code = self.code if self.project_id.use_custom_code else self.developer_code
