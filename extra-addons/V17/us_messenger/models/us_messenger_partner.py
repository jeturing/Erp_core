...
class UsMessengerPartner(models.Model):
    ...
    messenger_operator_id = fields.Many2one('res.partner', related='channel_id.messenger_operator_id')
    ...
    def action_become_operator(self):
        ...
        new_member = self.sudo().channel_id.add_members(partner_id, open_chat_window=True, post_joined_message=False)
