...
class SaleOrder(models.Model):
        ...
        for order in self:
            ...
            for contract_line in all_contract_lines:
                ...
                vals = dict(
                    ...
                    user_cost=contract_product.user_cost * contract_line.product_id.recurring_interval,
    ...
    def _cart_update(self, product_id=None, line_id=None, add_qty=0, set_qty=0, **kwargs):
        ...
        if add_qty and (product.is_trial_price or product.is_user_pricing or product.saas_plan_id) and (not product or not product._is_add_to_cart_allowed()):
            raise UserError(_("This service is currently unavailable. Kindly contact admin."))
