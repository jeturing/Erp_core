...
#################################################################################
{
  ...
  "summary"              :  """Odoo SaaS Kit allows you to run your Odoo As A SaaS business. After installation and set uo you can sell Odoo As A Saas to your client via subscription based model, saaskit. Keywords: Odoo SaaS Kit | Odoo SaaS platform | Odoo SaaS implementation | Odoo SaaS provider | Odoo SaaS development | Odoo SaaS subscription | Odoo SaaS rocket | Odoo SaaS solutions | Odoo SaaS for businesses | Odoo SaaS management | Odoo Docker Instance""",
  "category"             :  "Industries",
  "version"              :  "1.4.4",
  "sequence"             :  1,
