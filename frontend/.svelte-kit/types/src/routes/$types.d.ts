...
type LayoutRouteId = RouteId | "/(admin)/admin-users" | "/(admin)/agreements" | "/(admin)/api-keys" | "/(admin)/audit" | "/(admin)/billing" | "/(admin)/blueprints" | "/(admin)/branding" | "/(admin)/catalog" | "/(admin)/clients" | "/(admin)/commissions" | "/(admin)/communications" | "/(admin)/dashboard" | "/(admin)/developer-portal" | "/(admin)/dispersion" | "/(admin)/domains" | "/(admin)/infrastructure" | "/(admin)/invoices" | "/(admin)/landing-sections" | "/(admin)/leads" | "/(admin)/logs" | "/(admin)/migrations" | "/(admin)/neural-users" | "/(admin)/onboarding-config" | "/(admin)/partners" | "/(admin)/plan-governance" | "/(admin)/plans" | "/(admin)/quotas" | "/(admin)/quotations" | "/(admin)/reconciliation" | "/(admin)/reports" | "/(admin)/roles" | "/(admin)/seats" | "/(admin)/session-monitoring" | "/(admin)/settings" | "/(admin)/settlements" | "/(admin)/stripe-connect" | "/(admin)/tenants" | "/(admin)/testimonials" | "/(admin)/translations" | "/(admin)/tunnels" | "/(admin)/workorders" | "/(portal)/accountant-portal" | "/(portal)/customer-onboarding" | "/(portal)/partner-portal" | "/(portal)/portal" | "/(public)" | "/(public)/about" | "/(public)/accountants" | "/(public)/data-processing" | "/(public)/login" | "/(public)/login/admin" | "/(public)/onboarding-access" | "/(public)/partner-signup" | "/(public)/plt/[slug]" | "/(public)/pricing" | "/(public)/privacy" | "/(public)/recover-account" | "/(public)/security" | "/(public)/servicios" | "/(public)/signup" | "/(public)/sla" | "/(public)/terms" | "/admin" | null
